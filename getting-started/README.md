...
* **Rova Web**: [https://app.rova.qa](https://app.rova.qa) - For web application automation and management.
* **Rova Mobile**: [https://mobile.rova.qa](https://mobile.rova.qa) - For iOS and Android mobile application automation.
