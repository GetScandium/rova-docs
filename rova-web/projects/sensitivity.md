...
> [!CAUTION]
> **Warning**: Avoid using production databases for automated testing whenever possible. Even with high sensitivity settings, the safest way to handle data is to use isolated staging or test environments with anonymized data.

<!-- ## Redaction in Reports
When a test is marked as sensitive, the **Run History** will show:
- Redacted screenshots.
- Masked console logs.
- Hidden "Agent Thoughts" for the sensitive portions of the run. -->
