...
> [!IMPORTANT]
> When using Continuity Mode, the order of tests matters. Ensure your tests follow a logical sequence if they depend on the state created by previous tests.
...
- **Webhook/API**: Trigger the suite from your CI/CD pipeline using the Rova CLI or API.
...
> [!TIP]
> **Recommendation**: Always enable **Notifications** for your regression suites so your team is immediately alerted if a stable feature breaks.
